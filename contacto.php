...
<main class="container">
    <section id="contacto" class="my-5">
        ...
        if (isset($_SESSION['errores_contacto']) && !empty($_SESSION['errores_contacto'])) {
                ...
                <form id="formulario-contacto" method="post" action="procesar_contacto.php">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre"
                            value="<?php echo isset($_SESSION['datos_formulario']['nombre']) ? $_SESSION['datos_formulario']['nombre'] : ''; ?>"
                            required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" name="email"
                            value="<?php echo isset($_SESSION['datos_formulario']['email']) ? $_SESSION['datos_formulario']['email'] : ''; ?>"
                            required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control" id="telefono" name="telefono"
                            value="<?php echo isset($_SESSION['datos_formulario']['telefono']) ? $_SESSION['datos_formulario']['telefono'] : ''; ?>">
                    </div>

                    <div class="mb-3">
                        <label for="mensaje" class="form-label">Mensaje</label>
                        <textarea class="form-control" id="mensaje" name="mensaje" rows="4"
                            required><?php echo isset($_SESSION['datos_formulario']['mensaje']) ? $_SESSION['datos_formulario']['mensaje'] : ''; ?></textarea>
                    </div>
